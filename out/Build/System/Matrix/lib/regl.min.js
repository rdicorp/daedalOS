(function (Z, ka) {
    "object" === typeof exports && "undefined" !== typeof module ? (module.exports = ka()) : "function" === typeof define && define.amd ? define(ka) : (Z.createREGL = ka());
})(this, function () {
    function Z(a, b) {
        this.id = Db++;
        this.type = a;
    ...
    function ka(a) {
        ...
        if ((b = /\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(a)))
            return ka(a.substr(0, b.index))
                .concat(ka(b[1]))
                .concat(ka(a.substr(b.index + b[0].length)));
        b = a.split(".");
        if (1 === b.length) return ['"' + a.replace(/\\/g, "\\\\").replace(/"/g, '\\"') + '"'];
        a = [];
        for (c = 0; c < b.length; ++c) a = a.concat(ka(b[c]));
        return a;
    }
    function cb(a) {
        return "[" + ka(a).join("][") + "]";
    ...
    function Fb(a, b, c) {
        function e() {
            ...
            a !== document.body && ((e = f.getBoundingClientRect()), (b = e.right - e.left), (e = e.bottom - e.top));
            f.width = c * b;
            f.height = c * e;
        }
    ...
    function Hb(a) {
        ...
        "string" === typeof b
            ...
            : "object" === typeof b &&
            ("string" === typeof b.nodeName && "function" === typeof b.appendChild && "function" === typeof b.getBoundingClientRect
                ? (c = b)
                : "function" === typeof b.drawArrays || "function" === typeof b.drawElements
                    ? ((d = b), (f = d.canvas))
                    : ("gl" in b ? (d = b.gl) : "canvas" in b ? (f = fb(b.canvas)) : "container" in b && (e = fb(b.container)),
                        "attributes" in b && (a = b.attributes),
                        "extensions" in b && (q = eb(b.extensions)),
                        "optionalExtensions" in b && (n = eb(b.optionalExtensions)),
                        "onDone" in b && (u = b.onDone),
                        "profile" in b && (k = !!b.profile),
                        "pixelRatio" in b && (v = +b.pixelRatio)));
        c && ("canvas" === c.nodeName.toLowerCase() ? (f = c) : (e = c));
        if (!d) {
            if (!f) {
                c = Fb(e || document.body, u, v);
                if (!c) return null;
                f = c.canvas;
                m = c.onDestroy;
            }
        ...
        return d
            ? { gl: d, canvas: f, container: e, extensions: q, optionalExtensions: n, pixelRatio: v, profile: k, onDone: u, onDestroy: m }
    ...
    function ib(a, b, c, e, f, d) {
        for (var q = 0; q < b; ++q) for (var n = a[q], v = 0; v < c; ++v) for (var k = n[v], u = 0; u < e; ++u) f[d++] = k[u];
    }
    function jb(a, b, c, e, f) {
        ...
        if (4 === b.length - c) {
            var v = b[c + 1],
                k = b[c + 2];
            b = b[c + 3];
            for (q = 0; q < n; ++q) ib(a[q], v, k, b, e, f), (f += d);
    ...
    function lb(a, b, c, e, f, d, q) {
        for (var n = 0, v = 0; v < c; ++v) for (var k = 0; k < e; ++k) a[n++] = b[f * v + d * k + q];
    }
    function Jb(a, b, c, e) {
        function f(b) {
            this.id = v++;
        ...
        function q(a, b, c, g, h, r) {
            a.usage = c;
            if (Array.isArray(b)) {
                if (((a.dtype = g || 5126), 0 < b.length))
                    if (Array.isArray(b[0])) {
                        h = mb(b);
                        for (var p = (g = 1); p < h.length; ++p) g *= h[p];
                        a.dimension = g;
                        b = Ua(b, h, a.dtype);
                        d(a, b, c);
                        ...
                        "number" === typeof b[0]
                            ? ((a.dimension = h), (h = G.allocType(a.dtype, b.length)), kb(h, b), d(a, h, c), r ? (a.persistentData = h) : G.freeType(h))
                            : O(b[0]) && ((a.dimension = b[0].length), (a.dtype = g || Ha(b[0]) || 5126), (b = Ua(b, [b.length, b[0].length], a.dtype)), d(a, b, c), r ? (a.persistentData = b) : G.freeType(b));
            } else if (O(b)) (a.dtype = g || Ha(b)), (a.dimension = h), d(a, b, c), r && (a.persistentData = new Uint8Array(new Uint8Array(b.buffer)));
            else if (la(b)) {
                h = b.shape;
                var e = b.stride,
                    p = b.offset,
                    ...
                    f = 0,
                    k = 0;
                1 === h.length ? ((t = h[0]), (ma = 1), (f = e[0]), (k = 0)) : 2 === h.length && ((t = h[0]), (ma = h[1]), (f = e[0]), (k = e[1]));
                a.dtype = g || Ha(b.data) || 5126;
                a.dimension = ma;
                h = G.allocType(a.dtype, t * ma);
                lb(h, b.data, t, ma, f, k, p);
                d(a, h, c);
                r ? (a.persistentData = h) : G.freeType(h);
            } else b instanceof ArrayBuffer && ((a.dtype = 5121), (a.dimension = h), d(a, b, c), r && (a.persistentData = new Uint8Array(new Uint8Array(b))));
        }
        function n(c) {
            b.bufferCount--;
            e(c);
            ...
            create: function (m, e, d, g) {
                function h(b) {
                    var e = 35044,
                        ...
                        m = 0,
                        f = 1;
                    Array.isArray(b) || O(b) || la(b) || b instanceof ArrayBuffer
                        ? (t = b)
                        : "number" === typeof b
                            ? (d = b | 0)
                            : b && ("data" in b && (t = b.data), "usage" in b && (e = nb[b.usage]), "type" in b && (m = Ja[b.type]), "dimension" in b && (f = b.dimension | 0), "length" in b && (d = b.length | 0));
                    r.bind();
                    t ? q(r, t, e, m, f, g) : (d && a.bufferData(r.type, d, e), (r.dtype = m || 5121), (r.usage = e), (r.dimension = f), (r.byteLength = d));
                    c.profile && (r.stats.size = r.byteLength * na[r.dtype]);
                    return h;
                }
                b.bufferCount++;
                var r = new f(e);
                ...
                h._reglType = "buffer";
                h._buffer = r;
                h.subdata = function (b, c) {
                    var t = (c || 0) | 0,
                        d;
                    r.bind();
                    if (O(b) || b instanceof ArrayBuffer) a.bufferSubData(r.type, t, b);
                    else if (Array.isArray(b)) {
                        if (0 < b.length)
                            if ("number" === typeof b[0]) {
                                var e = G.allocType(r.dtype, b.length);
                                kb(e, b);
                                a.bufferSubData(r.type, t, e);
                                G.freeType(e);
                            } else if (Array.isArray(b[0]) || O(b[0])) (d = mb(b)), (e = Ua(b, d, r.dtype)), a.bufferSubData(r.type, t, e), G.freeType(e);
                    } else if (la(b)) {
                        d = b.shape;
                        var m = b.stride,
                            g = (e = 0),
                            f = 0,
                            y = 0;
                        1 === d.length ? ((e = d[0]), (g = 1), (f = m[0]), (y = 0)) : 2 === d.length && ((e = d[0]), (g = d[1]), (f = m[0]), (y = m[1]));
                        d = Array.isArray(b.data) ? r.dtype : Ha(b.data);
                        d = G.allocType(d, e * g);
                        lb(d, b.data, e, g, f, y, b.offset);
                        a.bufferSubData(r.type, t, d);
                        G.freeType(d);
                    }
                    return h;
                };
                c.profile && (h.stats = r.stats);
                h.destroy = function () {
                    n(r);
                };
                return h;
    ...
    function Kb(a, b, c, e) {
        ...
        function d(d, e, f, g, h, r, p) {
            d.buffer.bind();
            var k;
            e
                ? ((k = p) || (O(e) && (!la(e) || O(e.data))) || (k = b.oes_element_index_uint ? 5125 : 5123), c._initBuffer(d.buffer, e, f, k, 3))
                : (a.bufferData(34963, r, f), (d.buffer.dtype = k || 5121), (d.buffer.usage = f), (d.buffer.dimension = 3), (d.buffer.byteLength = r));
            k = p;
            if (!p) {
            ...
            d.type = k;
            e = h;
            0 > e && ((e = d.buffer.byteLength), 5123 === k ? (e >>= 1) : 5125 === k && (e >>= 2));
            d.vertCount = e;
            e = g;
            0 > g && ((e = 4), (g = d.buffer.dimension), 1 === g && (e = 0), 2 === g && (e = 1), 3 === g && (e = 4));
            d.primType = e;
        }
        function q(a) {
            e.elementsCount--;
        ...
        return {
            create: function (a, b) {
                function l(a) {
                    if (a)
                        if ("number" === typeof a) g(a), (h.primType = 4), (h.vertCount = a | 0), (h.type = 5121);
                        else {
                            var b = null,
                                c = 35044,
                                e = -1,
                                ...
                                m = 0,
                                n = 0;
                            if (Array.isArray(a) || O(a) || la(a)) b = a;
                            else if (("data" in a && (b = a.data), "usage" in a && (c = nb[a.usage]), "primitive" in a && (e = Ka[a.primitive]), "count" in a && (f = a.count | 0), "type" in a && (n = k[a.type]), "length" in a))
                                m = a.length | 0;
                            else if (((m = f), 5123 === n || 5122 === n)) m *= 2;
                            else if (5125 === n || 5124 === n) m *= 4;
                            d(h, b, c, e, f, m, n);
                        }
                    else g(), (h.primType = 4), (h.vertCount = 0), (h.type = 5121);
                    return l;
                }
    ...
    function ob(a) {
        for (var b = G.allocType(5123, a.length), c = 0; c < a.length; ++c)
    ...
    function rb(a) {
        return Array.isArray(a) && 0 !== a.length && ra(a[0]) ? !0 : !1;
    }
    function aa(a) {
    ...
    function Va(a) {
        if (!a) return !1;
        var b = aa(a);
        return 0 <= Mb.indexOf(b) ? !0 : qb(a) || rb(a) || la(a);
    }
    function sb(a, b) {
        36193 === a.type ? ((a.data = ob(b)), G.freeType(b)) : (a.data = b);
    }
    function La(a, b, c, e, f, d) {
        a = "undefined" !== typeof C[a] ? C[a] : U[a] * za[b];
        d && (a *= 6);
        if (f) {
    ...
    function Nb(a, b, c, e, f, d, q) {
        ...
        function k(a, b) {
            if ("object" === typeof b && b) {
                ...
                var c = a.width,
                    ...
                    f = !1;
                "shape" in b
                    ? ((c = b.shape[0]), (e = b.shape[1]), 3 === b.shape.length && ((d = b.shape[2]), (f = !0)))
                    : ("radius" in b && (c = e = b.radius), "width" in b && (c = b.width), "height" in b && (e = b.height), "channels" in b && ((d = b.channels), (f = !0)));
                a.width = c | 0;
                a.height = e | 0;
                a.channels = d | 0;
                c = !1;
                "format" in b && ((c = b.format), (e = a.internalformat = E[c]), (a.format = V[e]), c in N && !("type" in b) && (a.type = N[c]), c in ga && (a.compressed = !0), (c = !0));
                !f && c ? (a.channels = U[a.format]) : f && !c && a.channels !== Oa[a.format] && (a.format = a.internalformat = Oa[a.channels]);
            }
        }
        function u(b) {
        ...
        function x(a, b) {
            var c = null;
            Va(b) ? (c = b) : b && (k(a, b), "x" in b && (a.xOffset = b.x | 0), "y" in b && (a.yOffset = b.y | 0), Va(b.data) && (c = b.data));
            if (b.copy) {
            ...
            else if (O(c)) (a.channels = a.channels || 4), (a.data = c), "type" in b || 5121 !== a.type || (a.type = Ia[Object.prototype.toString.call(c)] | 0);
            else if (qb(c)) {
                ...
                p = a.height;
                t = a.channels;
                for (var z = G.allocType(36193 === a.type ? 5126 : a.type, g * p * t), B = 0, ha = 0; ha < p; ++ha) for (var oa = 0; oa < g; ++oa) for (var Wa = 0; Wa < t; ++Wa) z[B++] = e[d * oa + h * ha + y * Wa + c];
                sb(a, z);
            } else if (aa(c) === Xa || aa(c) === Ya || aa(c) === ub) aa(c) === Xa || aa(c) === Ya ? (a.element = c) : (a.element = c.canvas), (a.width = a.element.width), (a.height = a.element.height), (a.channels = 4);
            else if (aa(c) === vb) (a.element = c), (a.width = c.width), (a.height = c.height), (a.channels = 4);
            else if (aa(c) === wb) (a.element = c), (a.width = c.naturalWidth), (a.height = c.naturalHeight), (a.channels = 4);
            else if (aa(c) === xb) (a.element = c), (a.width = c.videoWidth), (a.height = c.videoHeight), (a.channels = 4);
            else if (rb(c)) {
                e = a.width || c[0].length;
                d = a.height || c.length;
                h = a.channels;
                h = ra(c[0][0]) ? h || c[0][0].length : h || 1;
                y = Qa.shape(c);
                g = 1;
                for (p = 0; p < y.length; ++p) g *= y[p];
                g = G.allocType(36193 === a.type ? 5126 : a.type, g);
                Qa.flatten(c, y, "", g);
                sb(a, g);
                a.alignment = 1;
                a.width = e;
                a.height = d;
                a.channels = h;
                a.format = a.internalformat = Oa[h];
                a.needsFree = !0;
            }
        }
        function l(b, c, d, h, g) {
            ...
            u(b);
            y
                ? a.texSubImage2D(c, g, d, h, t, k, y)
                : b.compressed
                    ? a.compressedTexSubImage2D(c, g, d, h, p, z, B, f)
                    : b.needsCopy
                        ? (e(), a.copyTexSubImage2D(c, g, d, h, b.xOffset, b.yOffset, z, B))
                        : a.texSubImage2D(c, g, d, h, z, B, t, k, f);
        }
        function g() {
            return R.pop() || new m();
        }
        function h(a) {
            a.needsFree && G.freeType(a.data);
            m.call(a);
            R.push(a);
        }
        function r() {
        ...
        function P(a, b) {
            var c = null;
            if (Va(b)) (c = a.images[0] = g()), v(c, a), x(c, b), (a.mipmask = 1);
            else if ((k(a, b), Array.isArray(b.mipmap))) for (var d = b.mipmap, e = 0; e < d.length; ++e) (c = a.images[e] = g()), v(c, a), (c.width >>= e), (c.height >>= e), x(c, d[e]), (a.mipmask |= 1 << e);
            else (c = a.images[0] = g()), v(c, a), x(c, b), (a.mipmask = 1);
            v(a, a.images[0]);
        }
        function t(b, c) {
            for (var d = b.images, h = 0; h < d.length && d[h]; ++h) {
                ...
                u(g);
                p
                    ? a.texImage2D(y, f, z, z, B, p)
                    : g.compressed
                        ? a.compressedTexImage2D(y, f, k, ha, oa, 0, t)
                        : g.needsCopy
                            ? (e(), a.copyTexImage2D(y, f, z, g.xOffset, g.yOffset, ha, oa, 0))
                            : a.texImage2D(y, f, z, ha, oa, 0, z, B, t || null);
            }
        }
        function ma() {
            var a = Y.pop() || new r();
        ...
        function ya(a) {
            for (var b = a.images, c = 0; c < b.length; ++c) b[c] && h(b[c]), (b[c] = null);
            Y.push(a);
        }
        function w() {
        ...
        function H(a, b) {
            "min" in b && ((a.minFilter = Aa[b.min]), 0 <= Pb.indexOf(a.minFilter) && !("faces" in b) && (a.genMipmaps = !0));
            "mag" in b && (a.magFilter = S[b.mag]);
            var c = a.wrapS,
                d = a.wrapT;
            if ("wrap" in b) {
                var e = b.wrap;
                "string" === typeof e ? (c = d = ia[e]) : Array.isArray(e) && ((c = ia[e[0]]), (d = ia[e[1]]));
            } else "wrapS" in b && (c = ia[b.wrapS]), "wrapT" in b && (d = ia[b.wrapT]);
            a.wrapS = c;
            a.wrapT = d;
        ...
        function F(b) {
            var c = b.texture,
                e = b.unit,
                g = b.target;
            0 <= e && (a.activeTexture(33984 + e), a.bindTexture(g, null), (W[e] = null));
            a.deleteTexture(c);
            b.texture = null;
            b.params = null;
            b.pixels = null;
        ...
        var A = { "don't care": 4352, "dont care": 4352, nice: 4354, fast: 4353 },
            ia = { repeat: 10497, clamp: 33071, mirror: 33648 },
            S = { nearest: 9728, linear: 9729 },
            Aa = L({ mipmap: 9987, "nearest mipmap nearest": 9984, "linear mipmap nearest": 9985, "nearest mipmap linear": 9986, "linear mipmap linear": 9987 }, S),
            Ob = { none: 0, browser: 37444 },
            N = { uint8: 5121, rgba4: 32819, rgb565: 33635, "rgb5 a1": 32820 },
            E = { alpha: 6406, luminance: 6409, "luminance alpha": 6410, rgb: 6407, rgba: 6408, rgba4: 32854, "rgb5 a1": 32855, rgb565: 36194 },
            ga = {};
        ...
        var J = Array.prototype.slice.call(a.getParameter(34467));
        ...
        var V = C.reduce(function (a, c) {
            ...
            Qb = 0,
            ea = {},
            fa = c.maxTextureUnits,
            W = Array(fa).map(function () {
                return null;
            });
        L(y.prototype, {
            bind: function () {
        ...
        q.profile &&
            (d.getTotalTextureSize = function () {
                var a = 0;
                Object.keys(ea).forEach(function (b) {
                    a += ea[b].stats.size;
                });
                return a;
            });
        return {
            create2D: function (b, c) {
                function e(a, b) {
                    ...
                    w.call(c);
                    var d = ma();
                    "number" === typeof a ? ("number" === typeof b ? p(d, a | 0, b | 0) : p(d, a | 0, a | 0)) : a ? (H(c, a), P(d, a)) : p(d, 1, 1);
                    ...
                    wa();
                    ya(d);
                    q.profile && (f.stats.size = La(f.internalformat, f.type, d.width, d.height, c.genMipmaps, !1));
                    e.format = ca[f.internalformat];
                    e.type = K[f.type];
                    e.mag = Fa[c.magFilter];
                    e.min = pa[c.minFilter];
                    e.wrapS = qa[c.wrapS];
                    e.wrapT = qa[c.wrapT];
                    return e;
                }
                ...
                e.subimage = function (a, b, c, d) {
                    ...
                    y.height = 0;
                    x(y, a);
                    y.width = y.width || (f.width >> d) - b;
                    y.height = y.height || (f.height >> d) - c;
                    T(f);
                    l(y, 3553, b, c, d);
                    wa();
                    h(y);
                ...
                e.resize = function (b, c) {
                    var d = b | 0,
                        g = c | 0 || d;
                    if (d === f.width && g === f.height) return e;
                    e.width = f.width = d;
                    e.height = f.height = g;
                    T(f);
                    for (var y = 0; f.mipmask >> y; ++y) {
                        var h = d >> y,
                            z = g >> y;
                        if (!h || !z) break;
                        a.texImage2D(3553, y, f.format, h, z, 0, f.format, f.type, null);
                    }
                    wa();
                    q.profile && (f.stats.size = La(f.internalformat, f.type, d, g, !1, !1));
                    return e;
                };
            ...
            createCube: function (b, c, e, f, n, r) {
                function m(a, b, c, d, e, f) {
                    var g,
                        da = A.texInfo;
                    w.call(da);
                    for (g = 0; 6 > g; ++g) F[g] = ma();
                    if ("number" === typeof a || !a) for (a = a | 0 || 1, g = 0; 6 > g; ++g) p(F[g], a, a);
                    else if ("object" === typeof a)
                        if (b) P(F[0], a), P(F[1], b), P(F[2], c), P(F[3], d), P(F[4], e), P(F[5], f);
                        else if ((H(da, a), k(A, a), "faces" in a)) for (a = a.faces, g = 0; 6 > g; ++g) v(F[g], A), P(F[g], a[g]);
                        else for (g = 0; 6 > g; ++g) P(F[g], a);
                    v(A, F[0]);
                    A.mipmask = da.genMipmaps ? (F[0].width << 1) - 1 : F[0].mipmask;
                    A.internalformat = F[0].internalformat;
                    m.width = F[0].width;
                    m.height = F[0].height;
                    T(A);
                    for (g = 0; 6 > g; ++g) t(F[g], 34069 + g);
                    M(da, 34067);
                    wa();
                    q.profile && (A.stats.size = La(A.internalformat, A.type, m.width, m.height, da.genMipmaps, !0));
                    m.format = ca[A.internalformat];
                    m.type = K[A.type];
                    m.mag = Fa[da.magFilter];
                    m.min = pa[da.minFilter];
                    m.wrapS = qa[da.wrapS];
                    m.wrapT = qa[da.wrapT];
                    for (g = 0; 6 > g; ++g) ya(F[g]);
                    return m;
                }
                var A = new y(34067);
                ea[A.id] = A;
                ...
                m.subimage = function (a, b, c, d, e) {
                    ...
                    f.height = 0;
                    x(f, b);
                    f.width = f.width || (A.width >> e) - c;
                    f.height = f.height || (A.height >> e) - d;
                    T(A);
                    l(f, 34069 + a, c, d, e);
                    wa();
                    h(f);
                ...
                m.resize = function (b) {
                    ...
                    if (b !== A.width) {
                        ...
                        m.height = A.height = b;
                        T(A);
                        for (var c = 0; 6 > c; ++c) for (var d = 0; A.mipmask >> d; ++d) a.texImage2D(34069 + c, d, A.format, b >> d, b >> d, 0, A.format, A.type, null);
                        wa();
                        q.profile && (A.stats.size = La(A.internalformat, A.type, m.width, m.height, !1, !0));
                        return m;
                    }
                };
                m._reglType = "textureCube";
                m._texture = A;
                q.profile && (m.stats = A.stats);
                m.destroy = function () {
                    A.decRef();
                };
                return m;
            ...
            clear: function () {
                for (var b = 0; b < fa; ++b) a.activeTexture(33984 + b), a.bindTexture(3553, null), (W[b] = null);
                I(ea).forEach(F);
                d.cubeCount = 0;
                d.textureCount = 0;
            },
                ...
                I(ea).forEach(function (b) {
                    ...
                    for (var c = 0; 32 > c; ++c)
                        if (0 !== (b.mipmask & (1 << c)))
                            ...
                            else for (var d = 0; 6 > d; ++d) a.texImage2D(34069 + d, c, b.internalformat, b.width >> c, b.height >> c, 0, b.internalformat, b.type, null);
                    M(b.texInfo, b.target);
                });
            },
            refresh: function () {
                for (var b = 0; b < fa; ++b) {
    ...
    function Rb(a, b, c, e, f, d) {
        ...
        function m(a, b, c, d, g) {
            if (c) return (a = e.create2D({ width: a, height: b, format: d, type: g })), (a._texture.refCount = 0), new q(3553, a, null);
        ...
        function p(b) {
            ...
            for (d = 0; d < e.length; ++d) k(36064 + d, e[d]);
            ...
            k(36096, b.depthAttachment);
            k(36128, b.stencilAttachment);
            k(33306, b.depthStencilAttachment);
        ...
        function P(a, b) {
            function c(a, b) {
                ...
                var l = !0,
                    ...
                    pa = null,
                    M = !1;
                if ("number" === typeof a) (g = a | 0), (f = b | 0 || g);
                else if (a) {
                    "shape" in a ? ((f = a.shape), (g = f[0]), (f = f[1])) : ("radius" in a && (g = f = a.radius), "width" in a && (g = a.width), "height" in a && (f = a.height));
                    if ("color" in a || "colors" in a) (d = a.color || a.colors), Array.isArray(d);
                    if (!d) {
                        "colorCount" in a && (y = a.colorCount | 0);
                        "colorTexture" in a && ((l = !!a.colorTexture), (n = "rgba4"));
                        if ("colorType" in a && ((r = a.colorType), !l))
                            if ("half float" === r || "float16" === r) n = "rgba16f";
                            else if ("float" === r || "float32" === r) n = "rgba32f";
                        "colorFormat" in a && ((n = a.colorFormat), 0 <= ma.indexOf(n) ? (l = !0) : 0 <= ya.indexOf(n) && (l = !1));
                    }
                    if ("depthTexture" in a || "depthStencilTexture" in a) M = !(!a.depthTexture && !a.depthStencilTexture);
                    "depth" in a && ("boolean" === typeof a.depth ? (t = a.depth) : ((q = a.depth), (k = !1)));
                    "stencil" in a && ("boolean" === typeof a.stencil ? (k = a.stencil) : ((P = a.stencil), (t = !1)));
                    "depthStencil" in a && ("boolean" === typeof a.depthStencil ? (t = k = a.depthStencil) : ((pa = a.depthStencil), (k = t = !1)));
                } else g = f = 1;
                var V = null,
                    H = null,
                    T = null,
                    w = null;
                if (Array.isArray(d)) V = d.map(u);
                else if (d) V = [u(d)];
                else for (V = Array(y), d = 0; d < y; ++d) V[d] = m(g, f, l, n, r);
                g = g || V[0].width;
                f = f || V[0].height;
                q ? (H = u(q)) : t && !k && (H = m(g, f, M, "depth", "uint32"));
                P ? (T = u(P)) : k && !t && (T = m(g, f, !1, "stencil", "uint8"));
                pa ? (w = u(pa)) : !q && !P && k && t && (w = m(g, f, M, "depth stencil", "depth stencil"));
                t = null;
                for (d = 0; d < V.length; ++d) v(V[d], g, f), V[d] && V[d].texture && ((k = Za[V[d].texture._texture.format] * Ra[V[d].texture._texture.type]), null === t && (t = k));
                v(H, g, f);
                v(T, g, f);
                v(w, g, f);
                h(e);
                e.width = g;
                e.height = f;
                e.colorAttachments = V;
                e.depthAttachment = H;
                e.stencilAttachment = T;
                e.depthStencilAttachment = w;
                c.color = V.map(x);
                c.depth = x(H);
                c.stencil = x(T);
                c.depthStencil = x(w);
            ...
            return L(c, {
                resize: function (a, b) {
                    var d = Math.max(a | 0, 1),
                        g = Math.max(b | 0 || d, 1);
                    if (d === e.width && g === e.height) return c;
                    for (var f = e.colorAttachments, h = 0; h < f.length; ++h) l(f[h], d, g);
                    l(e.depthAttachment, d, g);
                    l(e.stencilAttachment, d, g);
                    l(e.depthStencilAttachment, d, g);
                    e.width = c.width = d;
                    e.height = c.height = g;
                    p(e);
                    return c;
            ...
            createCube: function (a) {
                function b(a) {
                    ...
                    if ("number" === typeof a) f = a | 0;
                        ...
                        h || ("colorCount" in a && (p = a.colorCount | 0), "colorType" in a && (t = a.colorType), "colorFormat" in a && (d = a.colorFormat));
                        "depth" in a && (g.depth = a.depth);
                        "stencil" in a && (g.stencil = a.stencil);
                        "depthStencil" in a && (g.depthStencil = a.depthStencil);
                    } else f = 1;
                    if (h)
                        if (Array.isArray(h)) for (a = [], d = 0; d < h.length; ++d) a[d] = h[d];
                        else a = [h];
                    else for (a = Array(p), h = { radius: f, format: d, type: t }, d = 0; d < p; ++d) a[d] = e.createCube(h);
                    g.color = Array(a.length);
                    for (d = 0; d < a.length; ++d) (p = a[d]), (f = f || p.width), (g.color[d] = { target: 34069, data: a[d] });
                    for (d = 0; 6 > d; ++d) {
                        for (p = 0; p < a.length; ++p) g.color[p].target = 34069 + d;
                        0 < d && ((g.depth = c[0].depth), (g.stencil = c[0].stencil), (g.depthStencil = c[0].depthStencil));
                        if (c[d]) c[d](g);
                        else c[d] = P(g);
                    }
    ...
    function Sb(a, b, c, e, f, d, q) {
        ...
        function v(c) {
            if (c !== r.currentVAO) {
                if (c) c.bindAttrs();
                    ...
                    for (var d = b.angle_instanced_arrays, e = 0; e < l.length; ++e) {
                        var g = l[e];
                        g.buffer
                            ? (a.enableVertexAttribArray(e), g.buffer.bind(), a.vertexAttribPointer(e, g.size, g.type, g.normalized, g.stride, g.offfset), d && g.divisor && d.vertexAttribDivisorANGLE(e, g.divisor))
                            : (a.disableVertexAttribArray(e), a.vertexAttrib4f(e, g.x, g.y, g.z, g.w));
                    }
        ...
        var x = c.maxAttributes,
            l = Array(x);
        for (c = 0; c < x; ++c) l[c] = new $a();
        var g = 0,
            h = {},
            r = {
                Record: $a,
                ...
                createVAO: function (a) {
                    function b(a) {
                        var e;
                        Array.isArray(a)
                            ? ((e = a), c.elements && c.ownsElements && c.elements.destroy(), (c.elements = null), (c.ownsElements = !1), (c.offset = 0), (c.count = 0), (c.instances = -1), (c.primitive = 4))
                            : (a.elements
                                ? ((e = a.elements),
                                    c.ownsElements
                                        ? ("function" === typeof e && "elements" === e._reglType ? c.elements.destroy() : c.elements(e), (c.ownsElements = !1))
                                        : d.getElements(a.elements)
                                            ? ((c.elements = a.elements), (c.ownsElements = !1))
                                            : ((c.elements = d.create(a.elements)), (c.ownsElements = !0)))
                                ...
                                (c.instances = -1),
                                (c.primitive = 4),
                                c.elements && ((c.count = c.elements._elements.vertCount), (c.primitive = c.elements._elements.primType)),
                        ...
                        for (var h = 0; h < e.length; ++h) {
                            var p = e[h],
                                k = (g[h] = new $a()),
                                m = p.data || p;
                            if (Array.isArray(m) || O(m) || la(m)) {
                                var l;
                                c.buffers[h] && ((l = c.buffers[h]), O(m) && l._buffer.byteLength >= m.byteLength ? l.subdata(m) : (l.destroy(), (c.buffers[h] = null)));
                                c.buffers[h] || (l = c.buffers[h] = f.create(p, 34962, !1, !0));
                                k.buffer = f.getBuffer(l);
                                ...
                                f.getBuffer(p)
                                    ? ((k.buffer = f.getBuffer(p)), (k.size = k.buffer.dimension | 0), (k.normalized = !1), (k.type = k.buffer.dtype), (k.offset = 0), (k.stride = 0), (k.divisor = 0), (k.state = 1))
                                    : f.getBuffer(p.buffer)
                                        ? ((k.buffer = f.getBuffer(p.buffer)),
                                            (k.size = (+p.size || k.buffer.dimension) | 0),
                                            (k.normalized = !!p.normalized || !1),
                                            (k.type = "type" in p ? Ja[p.type] : k.buffer.dtype),
                                            (k.offset = (p.offset || 0) | 0),
                                            (k.stride = (p.stride || 0) | 0),
                                            (k.divisor = (p.divisor || 0) | 0),
                                            (k.state = 1))
                                        : "x" in p && ((k.x = +p.x || 0), (k.y = +p.y || 0), (k.z = +p.z || 0), (k.w = +p.w || 0), (k.state = 2));
                        }
                        for (l = 0; l < c.buffers.length; ++l) !a[l] && c.buffers[l] && (c.buffers[l].destroy(), (c.buffers[l] = null));
                        c.refresh();
                        return b;
                    }
                    var c = new u();
                ...
                setVAO: b.oes_vertex_array_object ? n : v,
                clear: b.oes_vertex_array_object ? k : function () { },
            };
        u.prototype.bindAttrs = function () {
            for (var c = b.angle_instanced_arrays, e = this.attributes, g = 0; g < e.length; ++g) {
                var f = e[g];
                f.buffer
                    ? (a.enableVertexAttribArray(g), a.bindBuffer(34962, f.buffer.buffer), a.vertexAttribPointer(g, f.size, f.type, f.normalized, f.stride, f.offset), c && f.divisor && c.vertexAttribDivisorANGLE(g, f.divisor))
                    : (a.disableVertexAttribArray(g), a.vertexAttrib4f(g, f.x, f.y, f.z, f.w));
            }
            for (c = e.length; c < x; ++c) a.disableVertexAttribArray(c);
            (c = d.getElements(this.elements)) ? a.bindBuffer(34963, c.buffer.buffer) : a.bindBuffer(34963, null);
        };
        u.prototype.refresh = function () {
            var a = b.oes_vertex_array_object;
            a && (a.bindVertexArrayOES(this.vao), this.bindAttrs(), (r.currentVAO = null), a.bindVertexArrayOES(null));
        };
        u.prototype.destroy = function () {
            if (this.vao) {
                var a = b.oes_vertex_array_object;
                this === r.currentVAO && ((r.currentVAO = null), a.bindVertexArrayOES(null));
    ...
    function Tb(a, b, c, e) {
        ...
        function v(c, h, k) {
            var m;
            m = q(35632, c.fragId);
            var l = q(35633, c.vertId);
            h = c.program = a.createProgram();
            a.attachShader(h, m);
            a.attachShader(h, l);
            if (k) for (m = 0; m < k.length; ++m) (l = k[m]), a.bindAttribLocation(h, l[0], l[1]);
            a.linkProgram(h);
            l = a.getProgramParameter(h, 35718);
            e.profile && (c.stats.uniformsCount = l);
            var n = c.uniforms;
            for (m = 0; m < l; ++m)
                if ((k = a.getActiveUniform(h, m))) {
                    if (1 < k.size)
                        for (var v = 0; v < k.size; ++v) {
                            var u = k.name.replace("[0]", "[" + v + "]");
                            d(n, new f(u, b.id(u), a.getUniformLocation(h, u), k));
                        }
                    v = k.name;
                    1 < k.size && (v = v.replace("[0]", ""));
                    d(n, new f(v, b.id(v), a.getUniformLocation(h, v), k));
                }
            l = a.getProgramParameter(h, 35721);
            e.profile && (c.stats.attributesCount = l);
            c = c.attributes;
            for (m = 0; m < l; ++m) (k = a.getActiveAttrib(h, m)) && d(c, new f(k.name, b.id(k.name), a.getAttribLocation(h, k.name), k));
        }
        var k = {},
            u = {},
            m = {},
            ...
            program: function (b, d, e, f) {
                ...
                return L(w, {
                    destroy: function () {
                        w.refCount--;
                        if (0 >= w.refCount) {
                            a.deleteProgram(w.program);
                            var b = x.indexOf(w);
                            x.splice(b, 1);
                            c.shaderCount--;
                        }
                        0 >= l[w.vertId].refCount && (a.deleteShader(u[w.vertId]), delete u[w.vertId], delete m[w.fragId][w.vertId]);
                        Object.keys(m[w.fragId]).length || (a.deleteShader(k[w.fragId]), delete k[w.fragId], delete m[w.fragId]);
                    },
                });
            },
            restore: function () {
    ...
    function Ub(a, b, c, e, f, d, q) {
        function n(d) {
            ...
            var m = 0,
                ...
                h = null;
            O(d) ? (h = d) : d && ((m = d.x | 0), (n = d.y | 0), (l = (d.width || e.framebufferWidth - m) | 0), (g = (d.height || e.framebufferHeight - n) | 0), (h = d.data || null));
            c();
            d = l * g * 4;
            h || (5121 === f ? (h = new Uint8Array(d)) : 5126 === f && (h = h || new Float32Array(d)));
            a.pixelStorei(3333, 4);
            a.readPixels(m, n, l, g, 6408, f, h);
            return h;
        }
        function v(a) {
            var c;
        ...
        return function (a) {
            return a && "framebuffer" in a ? v(a) : n(a);
        };
    }
    function Ba(a) {
        ...
        function a() {
            ...
            return L(
                ...
                },
                {
                    ...
                    toString: function () {
                        return Ca([0 < b.length ? "var " + b.join(",") + ";" : "", Ca(a)]);
                    },
                }
            );
        }
    ...
    function w(a) {
        return new J(!1, !1, !1, a);
    }
    function K(a, b) {
        var c = a.type;
        if (0 === c) return (c = a.data.length), new J(!0, 1 <= c, 2 <= c, b);
        if (4 === c) return (c = a.data), new J(c.thisDep, c.contextDep, c.propDep, b);
        if (5 === c) return new J(!1, !1, !1, b);
        if (6 === c) {
                ...
                1 === q.type
                    ...
                    : 2 === q.type
                        ...
                        : 3 === q.type
                            ? (c = !0)
                            : 0 === q.type
                                ? ((c = !0), (q = q.data), 1 <= q && (e = !0), 2 <= q && (f = !0))
                                : 4 === q.type && ((c = c || q.data.thisDep), (e = e || q.data.contextDep), (f = f || q.data.propDep));
            }
    ...
    function Wb(a, b, c, e, f, d, q, n, v, k, u, m, x, l, g) {
        ...
        function p(a, b, c) {
            var d = h(a);
            Na.push(a);
            Array.isArray(c) ? ((ta[d] = c.slice()), (Ea[d] = c.slice())) : (ta[d] = Ea[d] = c);
            va[d] = b;
        }
        function P() {
            var a = Vb(),
            ...
            Object.keys(va).forEach(function (a) {
                Array.isArray(ta[a]) && ((g[a] = d.def(f.next, ".", a)), (da[a] = d.def(f.current, ".", a)));
            });
            var D = (a.constants = {});
            Object.keys(Pa).forEach(function (a) {
                D[a] = d.def(JSON.stringify(Pa[a]));
            });
            ...
            a.scopeAttrib = function (a) {
                a = b.id(a);
                if (a in ba) return ba[a];
                var d = k.scope[a];
                d || (d = k.scope[a] = new ea());
                return (ba[a] = c(d));
            };
            return a;
        }
        ...
        function C(a, b, c) {
            function d(a) {
                if (a in e) {
                    ...
                    "height" in c ? (da = c.height | 0) : (a = !1);
                    return new J(!a && b && b.thisDep, !a && b && b.contextDep, !a && b && b.propDep, function (a, b) {
                        var d = a.shared.context,
                            e = h;
                        "width" in c || (e = b.def(d, ".", "framebufferWidth", "-", z));
                        var f = da;
                        "height" in c || (f = b.def(d, ".", "framebufferHeight", "-", g));
                        return [z, g, e, f];
                    });
                }
                if (a in f) {
                    ...
                    a = K(ha, function (a, b) {
                        var c = a.invoke(b, ha),
                            ...
                            e = b.def(c, ".x|0"),
                            f = b.def(c, ".y|0"),
                            z = b.def('"width" in ', c, "?", c, ".width|0:", "(", d, ".", "framebufferWidth", "-", e, ")"),
                ...
                return b
                    ? new J(b.thisDep, b.contextDep, b.propDep, function (a, b) {
            ...
            if ((a = d("viewport"))) {
                var g = a;
                a = new J(a.thisDep, a.contextDep, a.propDep, function (a, b) {
                    var c = g.append(a, b),
                        d = a.shared.context;
        ...
        function H(a, c, d) {
            ...
            var f = a["static"],
                ...
                ba = null;
            xa(h) && xa(D)
                ? ((ba = u.program(D.id, h.id, null, d)),
                    (a = w(function (a, b) {
                        return a.link(ba);
                    })))
                : (a = new J((h && h.thisDep) || (D && D.thisDep), (h && h.contextDep) || (D && D.contextDep), (h && h.propDep) || (D && D.propDep), function (a, b) {
                    var c = a.shared.shader,
                        d;
                    d = h ? h.append(a, b) : b.def(c, ".", "frag");
                    var e;
                    e = D ? D.append(a, b) : b.def(c, ".", "vert");
        ...
        function M(a, b) {
            function c(a, b) {
                ...
                if (b) {
                    ...
                    if (h)
                        return new J(D.thisDep, D.contextDep, D.propDep, function (a, b) {
            ...
            var e = a["static"],
                ...
                D = (function () {
                    if ("vao" in e) {
                        var a = e.vao;
                        null !== a && null === k.getVAO(a) && (a = k.createVAO(a));
                        h = !0;
                        g.vao = a;
                        return w(function (b) {
                            var c = k.getVAO(a);
                    ...
                    if ("elements" in f) {
                        ...
                        return K(c, function (a, b) {
                            var d = a.shared,
                                ...
                                z = b.def("null"),
                                e = b.def(e, "(", f, ")"),
                                f = a.cond(e).then(z, "=", d, ".createStream(", f, ");")["else"](z, "=", d, ".getElements(", f, ");");
                            b.entry(f);
                            b.exit(a.cond(e).then(d, ".destroyStream(", z, ");"));
                            return (a.ELEMENTS = z);
                        });
                    }
                    return h
                        ? new J(D.thisDep, D.contextDep, D.propDep, function (a, b) {
                ...
                m = (function () {
                    ...
                    return ba
                        ? xa(X)
                            ...
                            : new J(X.thisDep, X.contextDep, X.propDep, function (a, b) {
                                var c = a.ELEMENTS;
                ...
                l = (function () {
                    ...
                    return ba
                        ? xa(X)
                            ? X
                                ? ja
                                    ? new J(ja.thisDep, ja.contextDep, ja.propDep, function (a, b) {
                            ...
                            : new J(X.thisDep || ja.thisDep, X.contextDep || ja.contextDep, X.propDep || ja.propDep, function (a, b) {
                                var c = a.ELEMENTS;
                ...
                p = c("instances", !1);
            return { elements: X, primitive: m, count: l, instances: p, offset: ja, vao: D, vaoActive: h, elementsActive: ba, static: g };
        }
        function y(a, b) {
            var c = a["static"],
                d = a.dynamic,
            ...
            Na.forEach(function (a) {
                ...
                switch (a) {
                    ...
                    case "blend.equation":
                        return b(
                            function (a) {
                                if ("string" === typeof a) return [fa[a], fa[a]];
                                if ("object" === typeof a) return [fa[a.rgb], fa[a.alpha]];
                            },
                            function (a, b, c) {
                    ...
                    case "stencil.opBack":
                        return b(
                            function (b) {
                                return ["stencil.opBack" === a ? 1029 : 1028, Ta[b.fail || "keep"], Ta[b.zfail || "keep"], Ta[b.zpass || "keep"]];
                            },
                            function (b, c, d) {
                                function e(a) {
        ...
        function wa(a, c) {
            ...
            Object.keys(d).forEach(function (a) {
                var c = d[a],
                    e = b.id(a),
                    z = new ea();
                if (Sa(c)) (z.state = 1), (z.buffer = f.getBuffer(f.create(c, 34962, !1, !0))), (z.type = 0);
                else {
                    var B = f.getBuffer(c);
                    if (B) (z.state = 1), (z.buffer = B), (z.type = 0);
                        ...
                        var B = Sa(c.buffer) ? f.getBuffer(f.create(c.buffer, 34962, !1, !0)) : f.getBuffer(c.buffer),
                            k = c.offset | 0,
                            m = c.stride | 0,
                            l = c.size | 0,
                            oa = !!c.normalized,
                            p = 0;
                        "type" in c && (p = Ja[c.type]);
                        c = c.divisor | 0;
                        z.buffer = B;
                        z.state = 1;
                        z.size = l;
                ...
                g[a] = w(function (a, b) {
                    ...
                    z.buffer && ((d.buffer = a.link(z.buffer)), (d.type = d.type || d.buffer + ".dtype"));
                    return (c[e] = d);
                });
            });
            Object.keys(e).forEach(function (a) {
                var b = e[a];
                g[a] = K(b, function (a, c) {
                    function d(a) {
                        c(B[a], "=", e, ".", a, "|0;");
                    }
                    var e = a.invoke(c, b),
                    ...
                    c(
                        ...
                        "}else{",
                        Da.map(function (a, b) {
                            return B[a] + "=" + e + ".constant.length>" + b + "?" + e + ".constant[" + b + "]:0;";
                        }).join(""),
                        "}}else{",
                        "if(",
                        g,
        ...
        function A(a, b, d, e, f) {
            ...
            g("viewport");
            g(h("scissor.box"));
            var n = 0 < Object.keys(ja).length,
                l = { framebuffer: l, draw: X, shader: q, state: ja, dirty: n, scopeVAO: null, drawVAO: null, useVAO: !1, attributes: {} };
            l.profile = t(a, f);
            l.uniforms = T(d, f);
            l.drawVAO = l.scopeVAO = X.vao;
            if (!l.drawVAO && q.program && !m && c.angle_instanced_arrays && X["static"].elements) {
                var r = !0;
                ...
                if (r && 0 < a.length) {
                    var u = k.getVAO(k.createVAO({ attributes: a, elements: X["static"].elements }));
                    l.drawVAO = new J(null, null, null, function (a, b) {
                        return a.link(u);
                    });
                    l.useVAO = !0;
                }
            }
            m ? (l.useVAO = !0) : (l.attributes = wa(b, f));
            l.context = F(e, f);
            return l;
        }
        function ia(a, b, c) {
        ...
        function S(a, b, c, d) {
            var e = a.shared,
                ...
                g = e.framebuffer,
                h;
            Ma && (h = b.def(e.extensions, ".webgl_draw_buffers"));
            var k = a.constants,
                e = k.drawBuffer,
                k = k.backBuffer;
            ...
            Ma && b(h, ".drawBuffersWEBGL(", e, "[", a, ".colorAttachments.length]);");
            b("}else{", f, ".bindFramebuffer(", 36160, ",null);");
            Ma && b(h, ".drawBuffersWEBGL(", k, ");");
            b("}", g, ".cur=", a, ";");
            d || b("}");
        }
        function Aa(a, b, c) {
            ...
            Na.forEach(function (b) {
                ...
                if (!(b in c.state)) {
                    ...
                    if (b in g) {
                        d = g[b];
                        B = f[b];
                        var p = R(ta[b].length, function (a) {
                            return m.def(d, "[", a, "]");
                        });
                        m(
                            a
                        ...
                        (d = m.def(l, ".", b)),
                            (p = a.cond(d, "!==", k, ".", b)),
                            m(p),
                            b in ua ? p(a.cond(d).then(e, ".enable(", ua[b], ");")["else"](e, ".disable(", ua[b], ");"), k, ".", b, "=", d, ";") : p(e, ".", va[b], "(", d, ");", k, ".", b, "=", d, ";");
                }
            });
        ...
        function I(a, b, c, d) {
            ...
            yb(Object.keys(c)).forEach(function (e) {
                ...
                if (!d || d(k)) {
                    ...
                    if (ua[e]) {
                        var l = ua[e];
                        xa(k) ? (m ? b(h, ".enable(", l, ");") : b(h, ".disable(", l, ");")) : b(a.cond(m).then(h, ".enable(", l, ");")["else"](h, ".disable(", l, ");"));
                        b(g, ".", e, "=", m, ";");
                    } else if (ra(m)) {
                        var p = f[e];
                        b(
                    ...
                    } else b(h, ".", va[e], "(", m, ");", g, ".", e, "=", m, ";");
                }
            });
        }
        function N(a, b) {
            W && (a.instancing = b.def(a.shared.extensions, ".angle_instanced_arrays"));
        }
        function E(a, b, c, d, e) {
            ...
            function g(a) {
                r = b.def();
                a(r, "=", f(), ";");
                "string" === typeof e ? a(p, ".count+=", e, ";") : a(p, ".count++;");
                l && (d ? ((u = b.def()), a(u, "=", n, ".getNumPendingQueries();")) : a(n, ".beginQuery(", p, ");"));
            }
            function h(a) {
                a(p, ".cpuTime+=", f(), "-", r, ";");
                l && (d ? a(n, ".pushScopeStats(", u, ",", n, ".getNumPendingQueries(),", p, ");") : a(n, ".endQuery();"));
            }
            function k(a) {
                var c = b.def(q, ".profile");
                b(q, ".profile=", a, ";");
                b.exit(q, ".profile=", c, ";");
            }
            var m = a.shared,
        ...
        function ga(a, b, c, d, e) {
            ...
            function g(c, d, e) {
                function f() {
                    b("if(!", p, ".buffer){", m, ".enableVertexAttribArray(", l, ");}");
                    var c = e.type,
                        g;
                    ...
                    W && ((c = e.divisor), b("if(", p, ".divisor!==", c, "){", a.instancing, ".vertexAttribDivisorANGLE(", [l, c], ");", p, ".divisor=", c, ";}"));
                }
                function k() {
                    b(
                        "if(",
                ...
                var m = h.gl,
                    l = b.def(c, ".location"),
                    p = b.def(h.attributes, "[", l, "]");
                c = e.state;
                var ha = e.buffer,
                    q = [e.x, e.y, e.z, e.w],
                    n = ["buffer", "normalized", "offset", "stride"];
            ...
            d.forEach(function (d) {
                ...
                if (k) {
                    ...
                    m = {};
                    Object.keys(new ea()).forEach(function (a) {
                        m[a] = b.def(l, ".", a);
                    });
                }
        ...
        function Q(a, c, d, e, f, g) {
            for (var h = a.shared, k = h.gl, m = {}, l, p = 0; p < e.length; ++p) {
                ...
                var q = a.link(q) + ".location",
                    x;
                if (t) {
                    if (!f(t)) continue;
                    if (xa(t)) {
                        n = t.value;
                        if (35678 === r || 35680 === r) (r = a.link(n._texture || n.color[0]._texture)), c(k, ".uniform1i(", q, ",", r + ".bind());"), c.exit(r, ".unbind();");
                        else if (35674 === r || 35675 === r || 35676 === r)
                            (u = a.global.def("new Float32Array([" + Array.prototype.slice.call(n) + "])")), (n = 2), 35675 === r ? (n = 3) : 35676 === r && (n = 4), c(k, ".uniformMatrix", n, "fv(", q, ",false,", u, ");");
                        else {
                            switch (r) {
                                case 5126:
                                    l = "1f";
                            ...
                            1 < u ? ((l += "v"), (n = a.global.def("[" + Array.prototype.slice.call(n) + "]"))) : (n = ra(n) ? Array.prototype.slice.call(n) : n);
                            c(k, ".uniform", l, "(", q, ",", n, ");");
                        }
                        continue;
                    } else x = t.append(a, c);
                    ...
                    if (!f(Ab)) continue;
                    x = c.def(h.uniforms, "[", b.id(n), "]");
                }
                35678 === r ? c("if(", x, "&&", x, '._reglType==="framebuffer"){', x, "=", x, ".color[0];", "}") : 35680 === r && c("if(", x, "&&", x, '._reglType==="framebufferCube"){', x, "=", x, ".color[0];", "}");
                n = 1;
                switch (r) {
                    case 35678:
                    case 35680:
                        r = c.def(x, "._texture");
                        c(k, ".uniform1i(", q, ",", r, ".bind());");
                        c.exit(r, ".unbind();");
                        continue;
                    case 5124:
                    case 35670:
                ...
                -1 === l.indexOf("Matrix") && 1 < u && ((l += "v"), (n = 1));
                if ("M" === l.charAt(0)) {
                    c(k, ".uniform", l, "(", q, ",");
                    var q = Math.pow(r - 35674 + 2, 2),
                        y = a.global.def("new Float32Array(", q, ")");
                    Array.isArray(x)
                        ? c(
                            "false,(",
                            R(q, function (a) {
                    ...
                    if (1 < n) {
                        for (var r = [], w = [], u = 0; u < n; ++u) Array.isArray(x) ? w.push(x[u]) : w.push(c.def(x + "[" + u + "]")), g && r.push(c.def());
                        g &&
                            c(
                                "if(!",
                                a.batchId,
                        ...
                        c(k, ".uniform", l, "(", q, ",", w.join(","), ");");
                    } else g && ((r = c.def()), c("if(!", a.batchId, "||", r, "!==", x, "){", r, "=", x, ";")), c(k, ".uniform", l, "(", q, ",", x, ");");
                    g && c("}");
                }
            }
        }
        function U(a, b, c, d) {
            function e(f) {
                var g = m[f];
                return g ? ((g.contextDep && d.contextDynamic) || g.propDep ? g.append(a, c) : g.append(a, b)) : b.def(k, ".", f);
            }
            function f() {
                function a() {
                    c(t, ".drawElementsInstancedANGLE(", [n, r, x, q + "<<((" + x + "-5121)>>1)", u], ");");
                }
                function b() {
                    c(t, ".drawArraysInstancedANGLE(", [n, q, r, u], ");");
                }
                p && "null" !== p ? (v ? a() : (c("if(", p, "){"), a(), c("}else{"), b(), c("}"))) : b();
            }
            function g() {
                function a() {
                    c(l + ".drawElements(" + [n, r, x, q + "<<((" + x + "-5121)>>1)"] + ");");
                }
                function b() {
                    c(l + ".drawArrays(" + [n, q, r] + ");");
                }
                p && "null" !== p ? (v ? a() : (c("if(", p, "){"), a(), c("}else{"), b(), c("}"))) : b();
            }
            var h = a.shared,
                ...
                p = (function () {
                    ...
                    if (e) {
                        ...
                        e = e.append(a, f);
                        m.elementsActive && f("if(" + e + ")" + l + ".bindBuffer(34963," + e + ".buffer.buffer);");
                    } else
                        (e = f.def()),
                            f(
                                e,
                                ...
                                ".currentVAO.elements);",
                                na ? "" : "if(" + e + ")" + l + ".bindBuffer(34963," + e + ".buffer.buffer);",
                                "}"
                            );
                    return e;
                })(),
            ...
            var u, t;
            W && ((u = e("instances")), (t = a.instancing));
            var x = p + ".type",
                v = m.elements && xa(m.elements) && !m.vaoActive;
            W && ("number" !== typeof u || 0 <= u) ? ("string" === typeof u ? (c("if(", u, ">0){"), f(), c("}else if(", u, "<0){"), g(), c("}")) : f()) : g();
        }
        function ca(a, b, c, d, e) {
            b = P();
            e = b.proc("body", e);
            W && (b.instancing = e.def(b.shared.extensions, ".angle_instanced_arrays"));
            a(b, e, c, d);
        ...
        function Z(a, b, c, d) {
            ...
            c.useVAO
                ...
                : (b(a.shared.vao, ".setVAO(null);"),
                    ga(a, b, c, d.attributes, function () {
                        return !0;
                    }));
            Q(
                a,
        ...
        function pa(a, b, c, d) {
            ...
            a.batchId = "a1";
            N(a, b);
            ga(a, b, c, d.attributes, e);
            Q(a, b, c, d.uniforms, e, !1);
            U(a, b, b, c);
        }
        function qa(a, b, c, d) {
            function e(a) {
            ...
            c.needsFramebuffer && S(a, m, c.framebuffer);
            I(a, m, c.state, e);
            c.profile && e(c.profile) && E(a, m, c, !1, !0);
            d
                ? (c.useVAO
                    ? c.drawVAO
                        ? e(c.drawVAO)
                            ? m(a.shared.vao, ".setVAO(", c.drawVAO.append(a, m), ");")
                            : k(a.shared.vao, ".setVAO(", c.drawVAO.append(a, k), ");")
                        : k(a.shared.vao, ".setVAO(", a.shared.vao, ".targetVAO);")
                    : (k(a.shared.vao, ".setVAO(null);"), ga(a, k, c, d.attributes, f), ga(a, m, c, d.attributes, e)),
                    Q(a, k, c, d.uniforms, f, !1),
                    Q(a, m, c, d.uniforms, e, !0),
                    U(a, k, m, c))
                : ((b = a.global.def("{}")),
        ...
        function V(a, b) {
            ...
            var g = b.framebuffer,
                h = !1;
            g ? (g.propDep ? (e = h = !0) : g.contextDep && e && (h = !0), h || S(a, d, g)) : S(a, d, null);
            b.state.viewport && b.state.viewport.propDep && (e = !0);
            Aa(a, d, b);
            I(a, d, b.state, function (a) {
                return !c(a);
            });
            (b.profile && c(b.profile)) || E(a, d, b, !1, "a1");
            b.contextDep = e;
            b.needsContext = f;
            b.needsFramebuffer = h;
            f = b.shader.progVar;
            if ((f.contextDep && e) || f.propDep) qa(a, d, b, null);
            else if (((f = f.append(a, d)), d(a.shared.gl, ".useProgram(", f, ".program);"), b.shader.program)) qa(a, d, b, b.shader.program);
            else {
        ...
        function aa(a, b, c) {
            ...
            if (e && la(e)) {
                ...
                g.forEach(function (b) {
                    var c = e[b];
                    if (Y.isDynamic(c)) "function" === typeof c && (c = e[b] = Y.unbox(c)), (b = K(c, null)), (h = h || b.thisDep), (k = k || b.propDep), (l = l || b.contextDep);
                    else {
                        f(m, ".", b, "=");
                        switch (typeof c) {
                            case "number":
                ...
                b.dynamic[c] = new Y.DynamicVariable(4, { thisDep: h, contextDep: l, propDep: k, ref: m, append: d });
                delete b["static"][c];
            }
        }
        var ea = k.Record,
            fa = { add: 32774, subtract: 32778, "reverse subtract": 32779 };
        c.ext_blend_minmax && ((fa.min = 32775), (fa.max = 32776));
        var W = c.angle_instanced_arrays,
            Ma = c.webgl_draw_buffers,
            na = c.oes_vertex_array_object,
            ta = { dirty: !0, profile: g.profile },
            Ea = {},
            Na = [],
            ua = {},
            va = {};
        ...
        p("depth.mask", "depthMask", !0);
        p("colorMask", "colorMask", [!0, !0, !0, !0]);
        r("cull.enable", 2884);
        ...
        p("sample.coverage", "sampleCoverage", [1, !1]);
        ...
        var tb = { gl: a, context: x, strings: b, next: Ea, current: ta, draw: m, elements: d, buffer: f, shader: u, attributes: k.state, vao: k, uniforms: v, framebuffer: n, extensions: c, timer: l, isBufferArgs: Sa },
            Pa = { primTypes: Ka, compareFuncs: ab, blendFuncs: Ga, blendEquations: fa, stencilOps: Ta, glTypes: Ja, orientationType: zb };
        Ma &&
            ((Pa.backBuffer = [1029]),
                (Pa.drawBuffer = R(e.maxDrawbuffers, function (a) {
                    return 0 === a
                        ? [0]
                        : R(a, function (a) {
                            return 36064 + a;
        ...
        return {
            ...
            procs: (function () {
                ...
                for (var p = 0; p < e.maxAttributes; ++p) {
                    var n = d.def(g.attributes, "[", p, "]"),
                        q = a.cond(n, ".buffer");
                    q.then(h, ".enableVertexAttribArray(", p, ");", h, ".bindBuffer(", 34962, ",", n, ".buffer.buffer);", h, ".vertexAttribPointer(", p, ",", n, ".size,", n, ".type,", n, ".normalized,", n, ".stride,", n, ".offset);")[
                        "else"
                    ](h, ".disableVertexAttribArray(", p, ");", h, ".vertexAttrib4f(", p, ",", n, ".x,", n, ".y,", n, ".z,", n, ".w);", n, ".buffer=null;");
                    d(q);
                    W && d(m, ".vertexAttribDivisorANGLE(", p, ",", n, ".divisor);");
                }
                ...
                Object.keys(ua).forEach(function (c) {
                    var e = ua[c],
                        g = f.def(l, ".", c),
                        m = a.block();
                    m("if(", g, "){", h, ".enable(", e, ")}else{", h, ".disable(", e, ")}", k, ".", c, "=", g, ";");
                    d(m);
                    b("if(", g, "!==", k, ".", c, "){", m, "}");
                });
                Object.keys(va).forEach(function (c) {
                    ...
                    ra(g)
                        ...
                        : ((m = f.def(l, ".", c)), (p = f.def(k, ".", c)), n(m, ");", k, ".", c, "=", m, ";"), b("if(", m, "!==", p, "){", n, "}"));
                    d(n);
                });
                return a.compile();
            })(),
    ...
    var Yb = function (a, b) {
        ...
        if (d) {
            ...
            if (36053 !== a.checkFramebufferStatus(36160)) d = !1;
                ...
                a.getError() ? (d = !1) : (a.deleteFramebuffer(q), a.deleteTexture(d), (d = 1 === n[0]));
                G.freeType(n);
            }
        }
        n = !0;
        ("undefined" !== typeof navigator && (/MSIE/.test(navigator.userAgent) || /Trident\//.test(navigator.appVersion) || /Edge/.test(navigator.userAgent))) ||
            ((n = a.createTexture()),
                (q = G.allocType(5121, 36)),
                a.activeTexture(33984),
            ...
            flatten: function (a, b, c, e) {
                ...
                switch (b.length) {
                    ...
                    case 2:
                        e = b[0];
                        b = b[1];
                        for (d = f = 0; d < e; ++d) for (var q = a[d], n = 0; n < b; ++n) c[f++] = q[n];
                        break;
                    case 3:
        ...
        Ja = { int8: 5120, int16: 5122, int32: 5124, uint8: 5121, uint16: 5123, uint32: 5125, float: 5126, float32: 5126 },
    ...
    na[5125] = 4;
    na[5126] = 4;
    var Ka = { points: 0, point: 0, lines: 1, line: 1, triangles: 4, triangle: 4, "line loop": 2, "line strip": 3, "triangle strip": 5, "triangle fan": 6 },
    ...
    U[6407] = U[35904] = 3;
    U[6408] = U[35906] = 4;
    var Xa = sa("HTMLCanvasElement"),
        Ya = sa("OffscreenCanvas"),
        ub = sa("CanvasRenderingContext2D"),
        vb = sa("ImageBitmap"),
        wb = sa("HTMLImageElement"),
        xb = sa("HTMLVideoElement"),
        Mb = Object.keys(Ia).concat([Xa, Ya, ub, vb, wb, xb]),
        za = [];
    za[5121] = 1;
    za[5126] = 4;
    za[36193] = 2;
            ...
            create: function (b, c) {
                function l(b, c) {
                    var d = 0,
                        ...
                        k = 32854;
                    "object" === typeof b && b
                        ? ("shape" in b ? ((e = b.shape), (d = e[0] | 0), (e = e[1] | 0)) : ("radius" in b && (d = e = b.radius | 0), "width" in b && (d = b.width | 0), "height" in b && (e = b.height | 0)),
                            "format" in b && (k = n[b.format]))
                        : "number" === typeof b
                            ? ((d = b | 0), (e = "number" === typeof c ? c | 0 : d))
                            : b || (d = e = 1);
                    if (d !== g.width || e !== g.height || k !== g.format)
                        return (
                            (l.width = g.width = d),
                            (l.height = g.height = e),
                            (g.format = k),
                            a.bindRenderbuffer(36161, g.renderbuffer),
                            a.renderbufferStorage(36161, k, d, e),
                ...
                l.resize = function (b, c) {
                    var d = b | 0,
                        e = c | 0 || d;
                    if (d === g.width && e === g.height) return l;
                    l.width = g.width = d;
                    l.height = g.height = e;
                    a.bindRenderbuffer(36161, g.renderbuffer);
                    a.renderbufferStorage(36161, g.format, d, e);
                    f.profile && (g.stats.size = Q[g.format] * g.width * g.height);
                    return l;
                };
    ...
    var Da = ["x", "y", "z", "w"],
        ...
        ab = { never: 512, less: 513, "<": 513, equal: 514, "=": 514, "==": 514, "===": 514, lequal: 515, "<=": 515, greater: 516, ">": 516, notequal: 517, "!=": 517, "!==": 517, gequal: 518, ">=": 518, always: 519 },
        Ta = { 0: 0, zero: 0, keep: 7680, replace: 7681, increment: 7682, decrement: 7683, "increment wrap": 34055, "decrement wrap": 34056, invert: 5386 },
        zb = { cw: 2304, ccw: 2305 },
        Ab = new J(!1, !1, !1, function () { }),
        $b = function (a, b) {
            function c() {
            ...
            return {
                ...
                update: function () {
                    ...
                    a = d.length;
                    if (0 !== a) {
                        k.length = Math.max(k.length, a + 1);
                        ...
                        for (c = a = 0; c < n.length; ++c) {
                            ...
                            g = k[g];
                            l = k[l];
                            l === g ? ((e.stats.gpuTime += e.sum / 1e6), q.push(e)) : ((e.startQueryIndex = g), (e.endQueryIndex = l), (n[a++] = e));
                        }
                        n.length = a;
                    }
                },
    ...
    return function (a) {
        function b() {
            if (0 === E.length) t && t.update(), (ca = null);
            else {
                ca = bb.next(b);
                u();
            ...
            return L(
                function (a, b) {
                    ...
                    if ("function" === typeof b)
                        if ("number" === typeof a) for (d = 0; d < a; ++d) m.call(this, null, b, d);
                        else if (Array.isArray(a)) for (d = 0; d < a.length; ++d) m.call(this, a[d], b, d);
        ...
        function k() {
            var a = Q.viewport,
                b = Q.scissor_box;
            a[0] = a[1] = b[0] = b[1] = 0;
            H.viewportWidth = H.framebufferWidth = H.drawingBufferWidth = a[2] = b[2] = l.drawingBufferWidth;
            H.viewportHeight = H.framebufferHeight = H.drawingBufferHeight = a[3] = b[3] = l.drawingBufferHeight;
        }
        function u() {
            H.tick += 1;
            H.time = x();
        ...
        if (!a) return null;
        var l = a.gl,
            g = l.getContextAttributes();
        l.isContextLost();
        var h = Ib(l, a);
        if (!h) return null;
        var r = Eb(),
            p = { vaoCount: 0, bufferCount: 0, elementsCount: 0, framebufferCount: 0, shaderCount: 0, textureCount: 0, cubeCount: 0, renderbufferCount: 0, maxTextureUnits: 0 },
            w = h.extensions,
            t = $b(l, w),
            G = Cb(),
            C = l.drawingBufferWidth,
            J = l.drawingBufferHeight,
            H = { tick: 0, time: 0, viewportWidth: C, viewportHeight: J, framebufferWidth: C, framebufferHeight: J, drawingBufferWidth: C, drawingBufferHeight: J, pixelRatio: a.pixelRatio },
            C = { elements: null, primitive: 4, count: -1, offset: 0, instances: -1 },
            M = Yb(l, w),
            y = Jb(l, p, a, function (a) {
                return K.destroyBuffer(a);
            }),
            T = Kb(l, w, y, p),
            K = Sb(l, w, M, p, y, T, C),
            F = Tb(l, r, p, a),
            ...
            O = Zb(l, w, M, p, a),
            S = Rb(l, w, M, A, O, p),
            I = Wb(l, r, w, M, y, T, A, S, {}, K, F, C, H, t, a),
            r = Ub(l, S, I.procs.poll, H, g, w, M),
            Q = I.next,
            N = l.canvas,
            E = [],
            R = [],
        ...
        var aa = (S.setFBO = q({ framebuffer: Y.define.call(null, 1, "framebuffer") }));
        m();
        g = L(q, {
            clear: function (a) {
                if ("framebuffer" in a)
                    if (a.framebuffer && "framebufferCube" === a.framebuffer_reglType) for (var b = 0; 6 > b; ++b) aa(L({ framebuffer: a.framebuffer.faces[b] }, a), n);
                    else aa(a, n);
                else n(null, a);
            },
            ...
            hasExtension: function (a) {
                return 0 <= M.extensions.indexOf(a.toLowerCase());
            },
            read: r,
            destroy: function () {
                E.length = 0;
