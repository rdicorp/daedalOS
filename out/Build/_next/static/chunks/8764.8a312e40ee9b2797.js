            ...
            (e.byteLength = function (t) {
                ...
                (e.toByteArray = function (t) {
                    var e,
                        ...
                        a = u > 0 ? f - 4 : f;
                    for (r = 0; r < a; r += 4)
                        (e = (n[t.charCodeAt(r)] << 18) | (n[t.charCodeAt(r + 1)] << 12) | (n[t.charCodeAt(r + 2)] << 6) | n[t.charCodeAt(r + 3)]), (h[l++] = (e >> 16) & 255), (h[l++] = (e >> 8) & 255), (h[l++] = 255 & e);
                    return (
                        2 === u && ((e = (n[t.charCodeAt(r)] << 2) | (n[t.charCodeAt(r + 1)] >> 4)), (h[l++] = 255 & e)),
                        1 === u && ((e = (n[t.charCodeAt(r)] << 10) | (n[t.charCodeAt(r + 1)] << 4) | (n[t.charCodeAt(r + 2)] >> 2)), (h[l++] = (e >> 8) & 255), (h[l++] = 255 & e)),
                        h
                    );
                }),
        ...
        48764: function (t, e, r) {
            ...
            (e.Buffer = u),
                ...
                (u.prototype.readBigInt64BE = j(function (t) {
                    ...
                    let e = this[t],
                        r = this[t + 7];
                    return (
                        (void 0 === e || void 0 === r) && C(t, this.length - 8), (BigInt((e << 24) + 65536 * this[++t] + 256 * this[++t] + this[++t]) << BigInt(32)) + BigInt(16777216 * this[++t] + 65536 * this[++t] + 256 * this[++t] + r)
                    );
                })),
            ...
            function _(t, e, r, n, i, o) {
                if (t > r || t < e) {
                    ...
                    throw (
                        ((n = o > 3 ? (0 === e || e === BigInt(0) ? `>= 0${i} and < 2${i} ** ${(o + 1) * 8}${i}` : `>= -(2${i} ** ${(o + 1) * 8 - 1}${i}) and < 2 ** ${(o + 1) * 8 - 1}${i}`) : `>= ${e}${i} and <= ${r}${i}`),
                ...
                O(
                    ...
                    function (t, e, r) {
                        let n = `The value of "${t}" is out of range.`,
                            i = r;
                        return (
                            Number.isInteger(r) && Math.abs(r) > 4294967296 ? (i = L(String(r))) : "bigint" == typeof r && ((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = L(i)), (i += "n")),
                    ...
                    for (
                        isNaN((e = Math.abs(e))) || e === 1 / 0
                            ...
                            : ((f = Math.floor(Math.log(e) / Math.LN2)),
                                ...
                                e * s >= 2 && (f++, (s /= 2)),
                                f + a >= l ? ((u = 0), (f = l)) : f + a >= 1 ? ((u = (e * s - 1) * Math.pow(2, i)), (f += a)) : ((u = e * Math.pow(2, a - 1) * Math.pow(2, i)), (f = 0)));
                        i >= 8;
