                        ...
                        typeof (a = function () {
                            ...
                            return (
                                ...
                                (r.prototype.getFloatArrayType = function () {
                                    return this.source && 4 === this.source.length ? Float32Array : Float64Array;
                                }),
                                ...
                                (r.prototype.updateByData = function () {
                                    var e = new Uint8Array(new (this.getFloatArrayType())([this.data]).buffer);
                                    this.source = e.reverse();
                                }),
                                ...
                                (o.prototype.readUint = function () {
                                    for (var e = this.readByte(), t = 8 - e.toString(2).length, n = e - (1 << (7 - t)), a = 0; a < t; a++) (n *= 256), (n += this.readByte());
                                    return n;
                                }),
                                (o.prototype.updateBySource = function () {
                                    for (this.data = [], this.offset = 0; this.offset < this.source.length; this.offset = p) {
                                        var t = this.readUint(),
                                            i = this.readUint(),
                                        ...
                                        c.setSource(y), this.data.push({ id: t, idHex: t.toString(16), data: c });
                                    }
                                }),
                                ...
                                (o.prototype.writeSections = function (e) {
                                    ...
                                    for (var t = 0; t < this.data.length; t++) {
                                        var n = this.data[t],
                                            a = n.data.source,
                                            i = a.length;
                                        this.writeUint(n.id, e), this.writeUint(i, e), e || this.source.set(a, this.offset), (this.offset += i);
                                    }
                                    return this.offset;
                                }),
                                ...
                                (p.prototype.fixDuration = function (e, t) {
                                    ...
                                    if (!o) return n("[fix-webm-duration] TimecodeScale section is missing"), !1;
                                    var p = i.getSectionById(1161);
                                    if (p) {
                                        if (!(0 >= p.getValue())) return n("[fix-webm-duration] Duration section is present"), !1;
                                        n("[fix-webm-duration] Duration section is present, but the value is empty"), p.setValue(e);
                                    } else n("[fix-webm-duration] Duration section is missing"), (p = new r("Duration", "Float")).setValue(e), i.data.push({ id: 1161, data: p });
                                    return o.setValue(1e6), i.updateByData(), a.updateByData(), this.updateByData(), !0;
                                }),
