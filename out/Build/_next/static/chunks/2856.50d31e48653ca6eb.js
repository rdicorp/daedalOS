        ...
        72856: function (e, r, t) {
            ...
            var i = function (e, r) {
                ...
                function u(e) {
                    ...
                    var r = 0;
                    if (" " !== e[0]) {
                        for (var n = 0, i = 0; e[r] === c;) n++, r++;
                        for (var o = ((e.length - r) * h + 1) >>> 0, s = new Uint8Array(o); e[r];) {
                            var f = t[e.charCodeAt(r)];
                            if (255 === f) return;
                            for (var u = 0, d = o - 1; (0 !== f || u < i) && -1 !== d; d--, u++) (f += (a * s[d]) >>> 0), (s[d] = f % 256 >>> 0), (f = (f / 256) >>> 0);
                            if (0 !== f) throw Error("Non-zero carry");
                            (i = u), r++;
                        }
                        if (" " !== e[r]) {
                            for (var l = o - i; l !== o && 0 === s[l];) l++;
                            for (var b = new Uint8Array(n + (o - l)), p = n; l !== o;) b[p++] = s[l++];
                            return b;
                        }
                    }
                }
                return {
                    encode: function (r) {
                        ...
                        for (var t = 0, n = 0, i = 0, o = r.length; i !== o && 0 === r[i];) i++, t++;
                        for (var s = ((o - i) * f + 1) >>> 0, h = new Uint8Array(s); i !== o;) {
                            for (var u = r[i], d = 0, l = s - 1; (0 !== u || d < n) && -1 !== l; l--, d++) (u += (256 * h[l]) >>> 0), (h[l] = u % a >>> 0), (u = (u / a) >>> 0);
                            if (0 !== u) throw Error("Non-zero carry");
                            (n = d), i++;
                        }
                        for (var b = s - n; b !== s && 0 === h[b];) b++;
                        for (var p = c.repeat(t); b < s; ++b) p += e.charAt(h[b]);
                        return p;
                    },
                    decodeUnsafe: u,
                    decode: function (e) {
            ...
            class s {
                ...
                prefixCodePoint;
                constructor(e, r, t) {
                    if (((this.name = e), (this.prefix = r), void 0 === r.codePointAt(0))) throw Error("Invalid prefix character");
            ...
            function c(e, r) {
                return new a({ ...(e.decoders ?? { [e.prefix]: e }), ...(r.decoders ?? { [r.prefix]: r }) });
            }
            class h {
                name;
                prefix;
                ...
                decoder;
                constructor(e, r, t, n) {
                    (this.name = e), (this.prefix = r), (this.baseEncode = t), (this.baseDecode = n), (this.encoder = new o(e, r, t)), (this.decoder = new s(e, r, n));
                }
                encode(e) {
            ...
            function f({ name: e, prefix: r, encode: t, decode: n }) {
                return new h(e, r, t, n);
            }
            function u({ name: e, prefix: r, alphabet: t }) {
                let { encode: o, decode: s } = i(t, e);
                return f({ prefix: r, name: e, encode: o, decode: (e) => n(s(e)) });
            }
            function d({ name: e, prefix: r, bitsPerChar: t, alphabet: n }) {
                return f({
                    prefix: r,
                    name: e,
                    encode: (e) =>
                        (function (e, r, t) {
                            ...
                            if ((0 !== s && (o += r[i & (a << (t - s))]), n)) for (; ((o.length * t) & 7) != 0;) o += "=";
                            return o;
                        })(e, n, t),
                    decode: (r) =>
                        (function (e, r, t, n) {
                            ...
                            for (let r = 0; r < o; ++r) {
                                ...
                                (c = (c << t) | o), (a += t) >= 8 && ((a -= 8), (s[h++] = 255 & (c >> a)));
                            }
                            if (a >= t || (255 & (c << (8 - a))) != 0) throw SyntaxError("Unexpected end of data");
                            return s;
                        })(r, n, t, e),
                });
            }
            let l = d({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
            d({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 }),
                d({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 }),
                d({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 }),
                d({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 }),
                d({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 }),
                d({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 }),
                d({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 }),
                d({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
            let b = u({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
            u({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
            var p = function e(r, t, n) {
                t = t || [];
                for (var i = (n = n || 0); r >= 2147483648;) (t[n++] = (255 & r) | 128), (r /= 128);
                for (; -128 & r;) (t[n++] = (255 & r) | 128), (r >>>= 7);
                return (t[n] = 0 | r), (e.bytes = n - i + 1), t;
            },
                y = function e(r, t) {
                    var n,
                        i = 0,
                    ...
                    do {
                        ...
                        (n = r[s++]), (i += o < 28 ? (127 & n) << o : (127 & n) * Math.pow(2, o)), (o += 7);
                    } while (n >= 128);
                    return (e.bytes = s - t), i;
                },
                g = function (e) {
            ...
            function x(e, r) {
                let { bytes: t, version: n } = e;
                return 0 === n
                    ? (function (e, r, t) {
                        let { prefix: n } = t;
                        if (n !== b.prefix) throw Error(`Cannot string encode V0 in ${t.name} encoding`);
                        let i = r.get(n);
                        if (null != i) return i;
                        {
                            let i = t.encode(e).slice(1);
                            return r.set(n, i), i;
                        }
                    })(t, E(e), r ?? b.encoder)
                    : (function (e, r, t) {
            ...
            class A {
                ...
                toV0() {
                    switch (this.version) {
                        ...
                        case 1: {
                            ...
                            if (e !== U) throw Error("Cannot convert a non dag-pb CID to CIDv0");
                            if (r.code !== D) throw Error("Cannot convert non sha2-256 multihash CID to CIDv0");
                            return A.createV0(r);
                        }
                        default:
                        ...
                        case 0: {
                            let { code: e, digest: r } = this.multihash,
                                t = (function (e, r) {
                                    ...
                                    return v(e, o, 0), v(t, o, n), o.set(r, i), new m(e, t, r, o);
                                })(e, r);
                            return A.createV1(this.code, t);
                        }
                        case 1:
                            return this;
                        default:
                ...
                static equals(e, r) {
                    ...
                    return (
                        ...
                        e.code === r.code &&
                        e.version === r.version &&
                        ((t = e.multihash) === (n = r.multihash) ||
                            (t.code === n.code &&
                                t.size === n.size &&
                                n.bytes instanceof Uint8Array &&
                                (function (e, r) {
                                    if (e === r) return !0;
                ...
                static asCID(e) {
                    ...
                    if ((null != e["/"] && e["/"] === e.bytes) || e.asCID === e) {
                        let { version: r, code: t, multihash: n, bytes: i } = e;
                        return new A(r, t, n, i ?? I(r, t, n.bytes));
                    }
                    if (!0 !== e[S]) return null;
                    {
                        let { version: r, multihash: t, code: i } = e,
                            o = (function (e) {
                                let r = n(e),
                                    [t, i] = w(r),
                                    [o, s] = w(r.subarray(i)),
                                ...
                                return new m(t, o, a, r);
                            })(t);
                        return A.create(r, i, o);
                    }
                }
                static create(e, r, t) {
                    if ("number" != typeof r) throw Error("String codecs are no longer supported");
                    if (!(t.bytes instanceof Uint8Array)) throw Error("Invalid digest");
                    switch (e) {
                        case 0:
                            if (r === U) return new A(e, r, t, t.bytes);
                            throw Error(`Version 0 CID must use dag-pb (code: ${U}) block encoding`);
                        case 1: {
                            let n = I(e, r, t.bytes);
                ...
                static createV0(e) {
                    return A.create(0, U, e);
                }
                static createV1(e, r) {
                    return A.create(1, e, r);
                }
                static decode(e) {
                    let [r, t] = A.decodeFirst(e);
                    if (0 !== t.length) throw Error("Incorrect length");
                    return r;
                }
                static decodeFirst(e) {
                    let r = A.inspectBytes(e),
                        t = r.size - r.multihashSize,
                        i = n(e.subarray(t, t + r.multihashSize));
                    if (i.byteLength !== r.multihashSize) throw Error("Incorrect length");
                    let o = i.subarray(r.multihashSize - r.digestSize),
                        s = new m(r.multihashCode, r.digestSize, o, i);
                    return [0 === r.version ? A.createV0(s) : A.createV1(r.codec, s), e.subarray(r.size)];
                }
                static inspectBytes(e) {
                    let r = 0,
                        t = () => {
                            let [t, n] = w(e.subarray(r));
                            return (r += n), t;
                        },
                        n = t(),
                        i = U;
                    if ((18 === n ? ((n = 0), (r = 0)) : (i = t()), 0 !== n && 1 !== n)) throw RangeError(`Invalid CID version ${n}`);
                    let o = r,
                        s = t(),
                        a = t(),
                        c = r + a;
                    return { version: n, codec: i, multihashCode: s, digestSize: a, multihashSize: c - o, size: c };
                }
                static parse(e, r) {
                    let [t, n] = (function (e, r) {
                        switch (e[0]) {
                            case "Q":
                                return [b.prefix, (r ?? b).decode(`${b.prefix}${e}`)];
                            case b.prefix:
                                return [b.prefix, (r ?? b).decode(e)];
                            case l.prefix:
                                return [l.prefix, (r ?? l).decode(e)];
                            default:
            ...
            function I(e, r, t) {
                ...
                return v(e, o, 0), v(r, o, n), o.set(t, i), o;
            }
            let S = Symbol.for("@ipld/js-cid/CID");
        },
    },
]);
